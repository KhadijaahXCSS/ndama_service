                                    ...
                                    while ($affiliate_store_page_query->have_posts()) : $affiliate_store_page_query->the_post(); ?>
                                        <div class="imagebox">
                                            <?php if(has_post_thumbnail()){
                                                ...
                                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/slider.png" alt="<?php echo esc_attr( 'slider', 'affiliate-store'); ?>" class="post-image"/>
                                            <?php } ?>
                        ...
                        <?php for ($affiliate_store_i = 1; $affiliate_store_i <= 2; $affiliate_store_i++) { ?>
                            <div class="offer-sec">
                                <?php if (empty(get_theme_mod('affiliate_store_offer_bg_image'.$affiliate_store_i))) { ?>
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/offer-img.png" alt="<?php echo esc_attr( 'offer-image', 'affiliate-store'); ?>"/>
                                <?php } else { ?>
                                    <img src="<?php echo esc_url(get_theme_mod('affiliate_store_offer_bg_image'.$affiliate_store_i)); ?>" alt="<?php echo esc_attr( 'offer-image', 'affiliate-store'); ?>" />
                                <?php } ?>
                            ...
                            foreach ($affiliate_store_product_categories as $affiliate_store_product_category) {
                                ...
                                <div class="cat-box p-4">
                                    ...
                                    if ($affiliate_store_thumbnail_id) {
                                        ...
                                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/dummy-post.png" alt="<?php echo esc_attr( 'image', 'affiliate-store'); ?>" class="post-image"/>
                                    <?php } ?>
