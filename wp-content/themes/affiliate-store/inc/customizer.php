...
function affiliate_store_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_setting('affiliate_store_product_sale_position',array(
	...
	$wp_customize->add_setting('affiliate_store_stickyheader',array(
		'default' => false,
		'sanitize_callback' => 'affiliate_store_sanitize_checkbox',
	));
	$wp_customize->add_control( 'affiliate_store_stickyheader', array(
	   'section'   => 'affiliate_store_topbar_section',
	   'label'	=> __('Check To Show Sticky Header','affiliate-store'),
	   'type'      => 'checkbox'
 	));
	...
	$wp_customize->add_setting('affiliate_store_metabox_seperator',array(
		'default' => '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('affiliate_store_metabox_seperator',array(
		'type' => 'text',
		'label' => __('Metabox Seperator','affiliate-store'),
		'description' => __('Ex: "/", "|", "-", ...','affiliate-store'),
		'section' => 'affiliate_store_blog_post_settings'
	)); 
	...
	$wp_customize->add_setting('affiliate_store_single_post_date',array(
		'default' => true,
		'sanitize_callback'	=> 'affiliate_store_sanitize_checkbox'
	));
	$wp_customize->add_control('affiliate_store_single_post_date',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Date ','affiliate-store'),
		'section' => 'affiliate_store_single_post_settings'
	));	

	$wp_customize->add_setting('affiliate_store_single_post_author',array(
		'default' => true,
		'sanitize_callback'	=> 'affiliate_store_sanitize_checkbox'
	));
	$wp_customize->add_control('affiliate_store_single_post_author',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Author','affiliate-store'),
		'section' => 'affiliate_store_single_post_settings'
	));

	$wp_customize->add_setting('affiliate_store_single_post_comment',array(
		'default' => true,
		'sanitize_callback'	=> 'affiliate_store_sanitize_checkbox'
	));
	$wp_customize->add_control('affiliate_store_single_post_comment',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Comments','affiliate-store'),
		'section' => 'affiliate_store_single_post_settings'
	));	

	$wp_customize->add_setting('affiliate_store_single_post_time',array(
		'default' => true,
		'sanitize_callback'	=> 'affiliate_store_sanitize_checkbox'
	));
	$wp_customize->add_control('affiliate_store_single_post_time',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Time','affiliate-store'),
		'section' => 'affiliate_store_single_post_settings'
	));	

	$wp_customize->add_setting('affiliate_store_single_post_metabox_seperator',array(
		'default' => '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('affiliate_store_single_post_metabox_seperator',array(
		'type' => 'text',
		'label' => __('Metabox Seperator','affiliate-store'),
		'description' => __('Ex: "/", "|", "-", ...','affiliate-store'),
		'section' => 'affiliate_store_single_post_settings'
	...
	$wp_customize->add_setting('affiliate_store_scroll_text',array(
		'default'	=> __('TOP','affiliate-store'),
		'sanitize_callback'	=> 'sanitize_text_field',
	));	
	$wp_customize->add_control('affiliate_store_scroll_text',array(
		'label'	=> __('Scroll To Top Button Text','affiliate-store'),
		'section'	=> 'affiliate_store_footer',
		'type'		=> 'text'
	));

	$wp_customize->add_setting( 'affiliate_store_scroll_top_shape', array(
		'default'           => 'circle',
		'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control( 'affiliate_store_scroll_top_shape', array(
		'label'    => __( 'Scroll to Top Button Shape', 'affiliate-store' ),
		'section'  => 'affiliate_store_footer',
		'settings' => 'affiliate_store_scroll_top_shape',
		'type'     => 'radio',
		'choices'  => array(
			'box'        => __( 'Box', 'affiliate-store' ),
			'curved' => __( 'Curved', 'affiliate-store'),
			'circle'     => __( 'Circle', 'affiliate-store' ),
		),
	));
