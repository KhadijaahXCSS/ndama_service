...
<div class="mainhead">
  <?php if(get_theme_mod('affiliate_store_enable_topbar_section', true) != ''){ ?>
    <div class="topbar-sec py-2">
      <div class="container">
        <div class="row">
          <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6 col-12 align-self-center top-text d-flex align-items-center gap-2 ">
          ...
          <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-12 align-self-center d-flex justify-content-between align-items-center">
            ...
            <?php if(get_theme_mod('affiliate_store_header_currency_switcher', true) != ''){ ?>
              ...
              <?php if (shortcode_exists('woocommerce_currency_switcher_drop_down_box')) : ?>
                  <span class="currency-box">
      ...
      <div class="row">
        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 align-self-center">
          <div class="logo">
            ...
            <div class="site-branding-text">
              <?php if (get_theme_mod('affiliate_store_title_enable', false)) { ?>
        ...
        <div class="col-xxl-5 col-xl-4 col-lg-4 col-md-8 col-sm-12 col-12 position-relative align-self-center">
          <?php if (get_theme_mod('affiliate_store_middle_header_img') != '') { ?>
            <img src="<?php echo esc_url(get_theme_mod('affiliate_store_middle_header_img')); ?>" alt="<?php echo esc_attr( 'header-image', 'affiliate-store'); ?>" class="topbar-img"/>
  ...
  <div class="menu-sec py-1 <?php echo esc_attr(affiliate_store_sticky_menu()); ?>">
    <div class="container">
      <div class="row">
