...
## Scripts
*************************************************/
function partdo_side_cart_scripts() {
...
add_action( 'wp_enqueue_scripts', 'partdo_side_cart_scripts' );

if ( ! function_exists( 'partdo_side_cart' ) ) {
	function partdo_side_cart(){
		?>
			<div class="cart-widget-side">
				<div class="site-scroll">
					<div class="cart-side-header">
						<div class="cart-side-title"><?php esc_html_e('Shopping Cart', 'partdo-core'); ?></div>
...
add_action('wp_footer', 'partdo_side_cart');
...
add_action( 'wp_ajax_nopriv_sidecart_quantity_button', 'partdo_sidecart_quantity_button_callback' );
add_action( 'wp_ajax_sidecart_quantity_button', 'partdo_sidecart_quantity_button_callback' );
function partdo_sidecart_quantity_button_callback() {
