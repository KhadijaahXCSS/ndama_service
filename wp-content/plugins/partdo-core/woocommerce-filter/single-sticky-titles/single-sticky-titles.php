...
## style and scripts  
*************************************************/ 
function partdo_single_sticky_titles_scripts() {
...
add_action( 'wp_enqueue_scripts', 'partdo_single_sticky_titles_scripts' );

/*************************************************
## Single Sticky Titles
*************************************************/ 
add_action('woocommerce_after_single_product','partdo_product_single_sticky_titles');
function partdo_product_single_sticky_titles(){
