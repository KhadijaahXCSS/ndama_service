<?php
if(get_theme_mod('partdo_single_image_zoom') == 1 || partdo_ft() == 'imgzoom'){
	
/*************************************************
## Scripts
*************************************************/
function partdo_image_zoom_scripts() {
...
add_action( 'wp_enqueue_scripts', 'partdo_image_zoom_scripts' );
...
function partdo_image_zoom_setup() {
	add_theme_support( 'wc-product-gallery-zoom' );
}
add_action( 'after_setup_theme', 'partdo_image_zoom_setup' );
