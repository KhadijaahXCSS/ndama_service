...
class Partdo_Deals_Product2_Widget extends Widget_Base {
    use Partdo_Helper;

    public function get_name() {
        return 'partdo-deals-product2';
    }
    public function get_title() {
        return 'Deals Product 2 (K)';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'title',
            [
                ...
                'default' => 'Take advantage now before the offer runs out',
	...
	protected function render() {
		...
		$output .= '<div class="products featured-box">';
		...
		$output .= '<div class="feature-description">';
		$output .= '  <p>'.esc_html($settings['title']).'</p>';
		$output .= '</div>';
		$output .= '</div>';
