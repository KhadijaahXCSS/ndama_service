...
class Partdo_Special_Product2_Widget extends Widget_Base {
    use Partdo_Helper;

    public function get_name() {
        return 'partdo-special-product2';
    }
    public function get_title() {
        return 'Special Product 2 (K)';
    }
	...
	protected function register_controls() {
		...
		$this->add_control( 'badge_bg_color',
           [
               'label' => esc_html__( 'Badge Background Color', 'partdo-core' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
               'selectors' => [
					'{{WRAPPER}} .klbth-module-deals .badge.sale , {{WRAPPER}} .klbth-module-deals .product-badges' => 'background-color: {{value}};',
               ],
			]
        );
		...
		$this->add_control( 'border_color',
           [
               ...
               'default' => '',
               'selectors' => [
					'{{WRAPPER}} .klbth-module-deals .deal-item:before' => 'border-color: {{value}};',
               ],
			]
        );
	...
	protected function render() {
		...
		$output .= '<div class="deal-item red-border">';
