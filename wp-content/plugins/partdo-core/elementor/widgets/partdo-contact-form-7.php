...
class Partdo_Contact_Form_7_Widget extends Widget_Base {
    use Partdo_Helper;
    public function get_name() {
        return 'partdo-contact-form-7';
    }
    ...
    protected function register_controls() {
        $this->start_controls_section( 'partdo_cf7_global_controls',
            [
                'label'=> esc_html__( 'Form Data', 'partdo-core' ),
                'tab'=> Controls_Manager::TAB_CONTENT
            ]
        );
		
        $this->add_control('partdo_cf7_form_id_control',
            [
                'label'=> esc_html__( 'Select Form', 'partdo-core' ),
                'type'=> Controls_Manager::SELECT2,
                'multiple'=> false,
                'options'=> $this->partdo_get_cf7(),
        ...
        $this->start_controls_section('cf7_form_style_section',
            [
                'label'=> esc_html__( 'Form Style', 'partdo-core' ),
        ...
        $this->add_responsive_control( 'cf7_form_custom_width',
            [
                'label' => esc_html__( 'Form Max Width', 'partdo-core' ),
        ...
        $this->add_responsive_control( 'cf7_form_input_height',
            [
                'label' => esc_html__( 'Input Height', 'partdo-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        // Style function
        $this->partdo_style_controls($hide=array(),$id='cf7_form_normal_style',$selector='input:not(.wpcf7-submit),{{WRAPPER}} textarea');
        ...
        // Style function
        $this->partdo_style_controls($hide=array('typo','margin'),$id='cf7_form_hover_style',$selector='input:not(.wpcf7-submit):hover,{{WRAPPER}} textarea:hover');
        ...
        $this->start_controls_tab( 'cf7_form_focus_tab',
            [ 'label'  => esc_html__( 'Focus', 'partdo-core' ) ]
        );
        // Style function
        $this->partdo_style_controls($hide=array('typo','margin'),$id='cf7_form_focus_style',$selector='input:not(.wpcf7-submit):focus,{{WRAPPER}} textarea:focus');
        ...
        $this->start_controls_section('cf7_formbtn_style_section',
            [
                'label' => esc_html__( 'Form Button Style', 'partdo-core' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
        ...
        // Style function
        $this->partdo_style_controls($hide=array(),$id='cf7_formbtn_normal_style',$selector='.wpcf7-submit');
        ...
        // Style function
        $this->partdo_style_controls($hide=array('typo','margin'),$id='cf7_formbtn_hover_style',$selector='.wpcf7-submit:hover');
    ...
    protected function render() {
        ...
        if (!empty($settings['partdo_cf7_form_id_control'])){
			echo '<div class="contact-form">';
			echo do_shortcode( '[contact-form-7 id="'.$settings['partdo_cf7_form_id_control'].'"]' );
			echo '</div><!-- contact-form -->';
        } else {
            esc_html_e('Please Select a Form','partdo-core');
        }
    }
}
